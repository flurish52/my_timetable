            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 px-4 py-6">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="mt-1.5 text-sm text-gray-500 leading-relaxed">
                        Sign in to access your timetable, past questions,<br class="hidden sm:block"/> classes and
                        school updates.
                    </p>
                </div>
                ...
                <!-- Status message -->
                <div v-if="status"
                     class="mb-5 flex items-center gap-2 text-sm font-medium text-emerald-700 bg-emerald-50 border border-emerald-100 rounded-lg px-4 py-3">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            >
                                ...
                                <!-- Eye closed -->
                                <svg v-else class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8"
                                     viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round"
