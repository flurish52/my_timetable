    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-50 p-4">
        <div class="w-full max-w-lg bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <div class="mt-6">
                ...
                <div v-else
                     class="w-full flex items-center justify-center gap-2 py-2.5 bg-primary/10 text-primary text-sm font-medium rounded-lg">
                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
                        <path d="M3 7.5l3 3 6-6.5" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"
            ...
            <div class="py-2">
                <ScanCTA @scan="router.visit('/scan')"/>
            </div>
