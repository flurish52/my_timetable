...
const nav = [
    ...
    { label: 'Courses', href: route('admin.courses.index'), icon: 'M12 6.253v13m0-13C10.832 5.483 9.246 5 7.5 5 5.755 5 4.168 5.483 3 6.253v13C4.168 18.483 5.755 18 7.5 18c1.746 0 3.332.483 4.5 1.253m0-13C13.168 5.483 14.754 5 16.5 5c1.745 0 3.332.483 4.5 1.253v13C19.832 18.483 18.245 18 16.5 18c-1.746 0-3.332.483-4.5 1.253' },
    { label: 'Departments', href: route('admin.departments.index'), icon: 'M3 21h18M5 21V7l8-4v18M19 21V11l-6-4m-3 4h.01M9 12h.01M9 16h.01' },
...
const isActive = (href) => page.url.startsWith(new URL(href, window.location.origin).pathname)
</script>
...
<template>
    <AppLayout>
        <div class="h-screen bg-gray-50 flex overflow-hidden">
            ...
            <!-- sidebar: fixed, own height, no scroll -->
            <aside
                class="fixed md:static z-40 top-0 left-0 h-full w-64 shrink-0 bg-white border-r border-gray-100 overflow-hidden transition-transform duration-200 md:translate-x-0"
          ...
          >
            ...
            <div class="flex-1 h-full overflow-y-auto">
                <header class="h-16 bg-white border-b border-gray-100 flex items-center px-4 md:hidden sticky top-0 z-20">
